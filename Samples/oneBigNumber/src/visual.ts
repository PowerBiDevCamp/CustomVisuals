...
export class Visual implements IVisual {
    ...
    public update(options: VisualUpdateOptions) {
      ...
      if (this.dataView != null) {
        ...
        var defaultBackgroundColor: Fill = { "solid": { "color": "#f0e199" } };
          ...
          case 'oneBigNumberProperties':
            objectEnumeration.push({
              ...
              properties: {
                ...
                backgroundColor: getValue<Fill>(this.dataView.metadata.objects, objectName, "backgroundColor", { "solid": { "color": "#f0e199" } }),
